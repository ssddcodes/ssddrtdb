...
public class ZotWS {
    ...
    public final Service INSTANCE = Service.ignite();
    ...
    /**
     * Statically import this for redirect utility functionality, see {@link Redirect}
     */
    public final Redirect redirect = getInstance().redirect;

    /**
     * Statically import this for  files utility functionality, see {@link Service.StaticFiles}
     */
    public final Service.StaticFiles staticFiles = getInstance().staticFiles;
     ...
     * @param filters The filters
     */
    public  void before(Filter... filters) {
        for (Filter filter : filters) {
     ...
     * @param filters The filters
     */
    public  void after(Filter... filters) {
        for (Filter filter : filters) {
     ...
     * @param filters    The filters
     */
    public  void before(String path, String acceptType, Filter... filters) {
        for (Filter filter : filters) {
     ...
     * @param filters    The filters
     */
    public  void after(String path, String acceptType, Filter... filters) {
        for (Filter filter : filters) {
     ...
     */
    public  void setSecure(String keystoreFile,
     ...
     * @param truststorePassword the trust store password
     */
    public  void secure(String keystoreFile,
                              String keystorePassword,
                              String truststoreFile,
                              String truststorePassword) {
        getInstance().secure(keystoreFile, keystorePassword, truststoreFile, truststorePassword);
     ...
     * -
     * Note: contemplate changing tonew  files paradigm {@link Service.StaticFiles}
     *
     ...
     * -
     * Note: contemplate use of new  files paradigm {@link Service.StaticFiles}
     *
     ...
     * as defined at <a href="https://www.eclipse.org/jetty/javadoc/current/org/eclipse/jetty/server/ForwardedRequestCustomizer.html">https://www.eclipse.org/jetty/javadoc/current/org/eclipse/jetty/server/ForwardedRequestCustomizer.html</a>
     */
