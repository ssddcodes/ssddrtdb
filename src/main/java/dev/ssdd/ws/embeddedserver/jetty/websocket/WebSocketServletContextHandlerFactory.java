 ...
 */
package dev.ssdd.ws.embeddedserver.jetty.websocket;
    ...
    public static ServletContextHandler create(Map<String, WebSocketHandlerWrapper> webSocketHandlers,
        ...
        if (webSocketHandlers != null) {
            try {
                ...
                webSocketIdleTimeoutMillis.ifPresent(aLong -> webSocketUpgradeFilter.getFactory().getPolicy().setIdleTimeout(aLong));
