...
import dev.ssdd.ws.*;
import dev.ssdd.ws.embeddedserver.jetty.HttpRequestWrapper;
import dev.ssdd.ws.route.HttpMethod;
import dev.ssdd.ws.serialization.SerializerChain;
...
public class MatcherFilter implements Filter {
    ...
    private dev.ssdd.ws.route.Routes routeMatcher;
     ...
     */
    public MatcherFilter(dev.ssdd.ws.route.Routes routeMatcher,
