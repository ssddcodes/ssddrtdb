...
import dev.ssdd.rtdb.playground.http.message.LineParser;
import dev.ssdd.rtdb.playground.http.message.ParserCursor;
...
public class DefaultHttpResponseParser extends AbstractMessageParser<HttpResponse> {
     ...
     *   {@link dev.ssdd.rtdb.playground.http.message.BasicLineParser#INSTANCE} will be used
